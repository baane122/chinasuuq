// ============================================================
// @chinasuuq/shared/constants
// Canonical constants shared across web & mobile apps.
// ============================================================

// ── Brand Colors ────────────────────────────────────────────

/**
 * Primary color palette and semantic color tokens.
 * These MUST match in both apps — web (CSS) and mobile (React Native).
 */
export const COLORS = {
  // Brand
  primary: "#FF5A0A",
...
// ── Spacing Tokens (React Native) ───────────────────────────

/**
 * Spacing scale for React Native layouts.
 * In web apps use Tailwind spacing instead.
 */
...
// ── Border Radius Tokens (React Native) ─────────────────────
...
// ── Font Family Tokens (React Native) ───────────────────────
...
/** ChinaSuuq WhatsApp contact number (without + prefix). */
...
/** Supabase project URL (safe to expose — anon-level only). */
export const SUPABASE_URL = "https://athkmrvsaijwgsyvwrbp.supabase.co";

/**
 * Supabase anonymous (public) key.
 * This is safe to ship to the client — RLS policies protect data.
 * NEVER commit the service_role key here.
 */
...
/** Default CNY → USD exchange rate (fallback when API unavailable). */
...
/** Cart localStorage / AsyncStorage key. */
...
/**
 * Top-level product categories with i18n labels.
 * The `slug` is URL-safe and used in routing.
 */
...
/**
 * Supported Chinese marketplace platforms.
 */
...
/** Human-readable labels for order statuses (English). */
