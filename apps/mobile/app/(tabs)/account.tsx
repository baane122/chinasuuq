  ...
  const menuItems: MenuItem[] = [
    {
      ...
      label: locale === "en" ? "Personal Information" : "Macluumaad Shakhsiyeed",
      subtitle: locale === "en" ? "Name, phone & business details" : "Magac, taleefan & faahfaahin ganacsi",
      route: "/profile/personal-info",
    },
    {
      id: "addresses",
      icon: <Home size={20} color={COLORS.primary} />,
      label: locale === "en" ? "Saved Addresses" : "Cinwaanada Kaydsan",
      subtitle: locale === "en" ? "Delivery addresses in Somalia" : "Cinwaanada gaarsiinta Soomaaliya",
      route: "/profile/addresses",
    },
    {
      id: "payments",
      icon: <CreditCard size={20} color={COLORS.primary} />,
      label: locale === "en" ? "Payment Methods" : "Hababka Lacag Bixinta",
    ...
    },
    {
      ...
      label: locale === "en" ? "Wishlist" : "Liiska Rabitaanka",
      subtitle: locale === "en" ? "Products you've saved" : "Alaabta aad kaydsay",
      route: "/profile/wishlist",
    },
    {
      id: "referral",
      icon: <Gift size={20} color={COLORS.primary} />,
      label: locale === "en" ? "Refer & Earn" : "Ku soo jeedi & Lacag",
      subtitle: locale === "en" ? "Invite friends, get rewards" : "Soo dhawoow saaxiibada, hel abaalmarino",
